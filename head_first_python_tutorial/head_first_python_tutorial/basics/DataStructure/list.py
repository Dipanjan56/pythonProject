...
# 1. SHALLOW COPY: copying the reference of the first list, but in this case of you change any object value of any of the
...
list comprehension is faster than the normal for loop
"""
# example:
...
s_list_4 = ['abcd', 'bvd', 'a', 'sdfds']
sorted_list = sorted(s_list_4, key=len)
